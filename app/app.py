...
def load_vectorstore():
    ...
    model_kwargs = {"device": "cpu"} if os.getenv("CUDA_VISIBLE_DEVICES", None) or True else {}
...
# 5.4) Sidebar info
with st.sidebar:
    st.header("👋 ਜੀ ਆਇਆਂ ਨੂੰ! ਤੁਹਾਡੇ ਆਪਣੇ ਪੰਜਾਬੀ ਸਹਾਇਕ ਕੋਲ।")
    st.write(
    "ਮੈਂ ਇੱਕ ਅਜਿਹਾ ਸਾਥੀ ਹਾਂ ਜੋ ਪੰਜਾਬੀ ਬੋਲੀ ਨੂੰ ਚੰਗੀ ਤਰ੍ਹਾਂ ਸਮਝਦਾ ਹੈ। ਚਾਹੇ ਕੋਈ ਪੁਰਾਣੀ ਕਹਾਣੀ ਹੋਵੇ ਜਾਂ ਕੋਈ ਡੂੰਘੀ ਗੱਲ, "
    "ਤੁਸੀਂ ਮੇਰੇ ਨਾਲ ਆਪਣੀ ਮਾਂ-ਬੋਲੀ ਵਿੱਚ ਗੱਲਬਾਤ ਕਰ ਸਕਦੇ ਹੋ।\n\n"
    "🌟 **ਮੈਂ ਤੁਹਾਡੀ ਕੀ ਮਦਦ ਕਰ ਸਕਦਾ ਹਾਂ?**\n"
    "* ਤੁਹਾਡੇ ਢੇਰ ਸਾਰੇ ਕਾਗਜ਼ਾਂ ਵਿੱਚੋਂ ਤੁਹਾਡੇ ਕੰਮ ਦੀ ਗੱਲ ਲੱਭ ਕੇ ਦੇਣਾ।\n"
    "* ਮੁਸ਼ਕਲ ਗੱਲਾਂ ਨੂੰ ਆਸਾਨ ਸ਼ਬਦਾਂ ਵਿੱਚ ਸਮਝਾਉਣਾ।\n"
    "* ਤੁਹਾਡੇ ਸਵਾਲਾਂ ਦੇ ਪਿਆਰੇ ਅਤੇ ਸਪੱਸ਼ਟ ਜਵਾਬ ਦੇਣਾ।"
)
